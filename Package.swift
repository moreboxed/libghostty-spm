...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/moreboxed/libghostty-spm/releases/download/storage.1.0.0/GhosttyKit.xcframework.zip",
            checksum: "8617ed3ada9517cc3d68961dbafc31d949453a806060fa042b73bcee81ca6bd1"
        ),
        .testTarget(
            name: "GhosttyKitTest",
